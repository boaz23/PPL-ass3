...
describe('L4 To mermaid', () => {
    it('L4 To Mermaid Test 1', () => {
        ...
        writeMermaidASTtoFile(mermaidAST, "graphs/graph1.mmd");
    ...
    it('L4 To Mermaid Test 2', () => {
        const mermaidAST = mapL4toMermaid(makeNumExp(1));
        writeMermaidASTtoFile(mermaidAST, "graphs/graph2.mmd");
        expect(mermaidAST).to.deep.eq(
    ...
    it('L4 To Mermaid Test 3', () => {
        ...
        writeMermaidASTtoFile(mermaidAST, "graphs/graph3.mmd");
        expect(mermaidAST).to.deep.eq(
            makeOk(makeGraph(makeTD(),
                makeCompoundGraph([
                    makeEdge(makeNodeDecl('Program_1', 'Program'), makeNodeDecl('Exps_1', ':'), 'exps'),
    ...
    it('L4 To Mermaid Test 4 - With Lit Exp', () => {
        ...
        writeMermaidASTtoFile(mermaidAST, "graphs/graph4.mmd");
        expect(mermaidAST).to.deep.eq(
            makeOk(makeGraph(makeTD(),
                makeCompoundGraph([
